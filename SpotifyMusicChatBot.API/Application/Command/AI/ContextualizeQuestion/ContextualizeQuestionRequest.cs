...
{
    /// <summary>
    /// Solicitud para contextualizar una pregunta basándose en el historial de conversación
    /// </summary>
    public class ContextualizeQuestionRequest : IRequest<ContextualizeQuestionResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Indica si se debe incluir el historial de conversación
        /// </summary>
        public bool IncludeContext { get; set; } = true;

        /// <summary>
        /// Límite de turnos del historial a considerar
        /// </summary>
